...
<html>
<head>
<title>My Show a Entertainment Category Flat Bootstarp responsive Website Template | Blog :: w3layouts</title>
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
					...
					<li class="dropdown active"><a href="#" data-toggle="dropdown" class="dropdown-toggle">页面<b class="caret"></b></a>
		...
		<div class="col-md-8 blog-posts">
			...
			<div class="blog-top">
			  <div class="col-md-6 grid_3">
					...
					<div class="blog-poast-info">
						<ul>
							<li><i class="fa fa-user"></i><a class="admin" href="#"><span> </span> 管理员 </a></li>
							<li><i class="fa fa-calendar"></i><span> </span>12-04-2015</li>
							<li><i class="fa fa-comments"></i><a class="p-blog" href="#"><span> </span>3 评论 </a></li>
						</ul>
				    </div>
					<h3><a href="single.html">Lorem Ipsum很简单</a></h3>
			...
			<div class="blog-top">
			  <div class="col-md-6 grid_3">
				...
				<div class="col-md-6 grid_3">
					<a href="single.html"><img src="images/b6.jpg" class="img-responsive" alt=""></a>
					<div class="blog-poast-info">
						<ul>
							<li><i class="fa fa-user"></i><a class="admin" href="#"><span> </span> 管理员 </a></li>
							<li><i class="fa fa-calendar"></i><span> </span>12-04-2015</li>
			...
			<div class="blog-top">
			  <div class="col-md-6 grid_3">
					<a href="single.html"><img src="images/b7.jpg" class="img-responsive" alt=""></a>
					<div class="blog-poast-info">
						<ul>
							<li><i class="fa fa-user"></i><a class="admin" href="#"><span> </span> 管理员 </a></li>
							<li><i class="fa fa-calendar"></i><span> </span>12-04-2015</li>
				...
				<div class="col-md-6 grid_3">
					<a href="single.html"><img src="images/b8.jpg" class="img-responsive" alt=""></a>
					<div class="blog-poast-info">
						<ul>
							<li><i class="fa fa-user"></i><a class="admin" href="#"><span> </span> 管理员 </a></li>
							<li><i class="fa fa-calendar"></i><span> </span>12-04-2015</li>
