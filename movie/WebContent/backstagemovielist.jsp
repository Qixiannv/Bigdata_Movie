          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <c:forEach items="${list }" var="p">
              <tr>
                ...
                <td>${p.movie_id}</td>
                <td><a href="#">${p.movie_name}</a></td>
                <td>${p.date}</td>
                <td >${p.time}</td>
                <td >${p.rate}</td>
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="ModProduct?id=${p.movie_id}"><span class="am-icon-pencil-square-o"></span></a>
                      <a href="ProductDelete?id=${p.movie_id}"><span class="am-icon-trash-o"></span></a>
                    </div>
                  </div></td>
              </tr>
              	</c:forEach>
